...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "d0de4f5d3ca12f59d626c6a98364650649c6033926c478e73f696f4e5a500541"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXFFmpeg.xcframework.zip",
            checksum: "41463fbdfabe026ae4c16e01160f59836eb4d3dc9bcc4b7637960de47d414635"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXSoundTouch.xcframework.zip",
            checksum: "aed315f2e71ebbeffa66cbffb82361ef3c1a4951f9e5a608414b0fcdecb0c1b0"
        ),.target(
            name: "Live_SwiftPM",
            dependencies: [
