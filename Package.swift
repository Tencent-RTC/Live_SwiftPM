...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "abba222854542120f5c9ec05a9e02935bb4745972f7d662fae11f3c613ba5a37"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXFFmpeg.xcframework.zip",
            checksum: "c335c75326da0e41ef2346cff4d26374409a30906b368c6fcd9b5f4050c01857"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXSoundTouch.xcframework.zip",
            checksum: "a738bd0481a70bf23c609ebd1445101bf6d54095dd82502fc4ae246d6e5ac9b0"
        ),.target(
            name: "Live_SwiftPM",
            dependencies: [
