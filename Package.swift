...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "7a8202fc8fedf9fe0a89a1819765533fb53741284fe6982f2610e80859370cf5"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXFFmpeg.xcframework.zip",
            checksum: "c16a0f21f2d3d63307825bef0e0308c2c4452cd8f4de8a7ee5b411d2e62518c4"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXSoundTouch.xcframework.zip",
            checksum: "74f5b478ceb5718a71fac8edd2e279260905ae95675bbfd7a362aaaa1e2d1509"
        ),.target(
            name: "Live_SwiftPM",
            dependencies: [
